  ...
  export default {
    ...
    methods: {
        ...
        try {
          if (this.editingCategory) {
            ...
            const response = await axios.put(
              `http://62.113.41.108/api/categories/${this.editingCategory.id}`,
              this.form
            );
            ...
            const response = await axios.post(
              'http://62.113.41.108/api/categories',
              this.form
            );
      ...
      async checkCategoryDependencies(categoryId) {
        try {
          const [childrenResponse, productsResponse] = await Promise.all([
            axios.get(`http://62.113.41.108/api/categories/children/${categoryId}`),
            axios.get(`http://62.113.41.108/api/categories/${categoryId}/products`)
          ]);
      ...
      async deleteCategory() {
        this.processing = true;
        try {
          await axios.delete(`http://62.113.41.108/api/categories/${this.selectedCategory.id}`);
