  ...
  export default {
    ...
    methods: {
        ...
        try {
          if (this.editingCategory) {
            ...
            const response = await axios.put(
              `http://voenerdgy.ru/api/categories/${this.editingCategory.id}`,
              this.form
            );
            ...
            const response = await axios.post(
              'http://voenerdgy.ru/api/categories',
              this.form
            );
      ...
      async checkCategoryDependencies(categoryId) {
        try {
          const [childrenResponse, productsResponse] = await Promise.all([
            axios.get(`http://voenerdgy.ru/api/categories/children/${categoryId}`),
            axios.get(`http://voenerdgy.ru/api/categories/${categoryId}/products`)
          ]);
      ...
      async deleteCategory() {
        this.processing = true;
        try {
          await axios.delete(`http://voenerdgy.ru/api/categories/${this.selectedCategory.id}`);
